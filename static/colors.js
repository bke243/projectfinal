...
let colors = {
                ...
                gold   : { name: "gold", color : "#F0D52D", value : 5, tolerance : 5, multiplier : -1}, /* this is a percentage*/
                ...
                silver : { name: "silver", color : "#BFC1C2", value : 10, tolerance : 10, multiplier : -2}, /* this is a percentage*/
...
function get_value(band, colors, parameter = "value")
{
    ...
    {
        console.log("the value is " + colors[value_of_the_band][parameter]);
...
function fourbands_calculator(list_of_bands, colors)
{
    ...
    for (value of fields)
    {
        ...
        console.log("band is " +" "+ value);
        if (typeof(input_value) != "number")
        {
            return null;
        }
        console.log("the value of "+ value+ "nowis"+ " "+input_value);
    }
...
{
    console.log("the main was called");
    ...
    {
        console.log("something went wrong " + "number of bands of specified");
    }
}
...
$(document).ready(function ()
{
    ...
    $("#second_form select").change(function ()
    {
        ...
        console.log("the number of band is " + document.querySelector('input[name = "band"]:checked').value);
